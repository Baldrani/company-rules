...
exports.DEFAULT_SELECTED_AGENTS = exports.DEFAULT_SELECTED_IDES = exports.SUPPORTED_AGENTS = exports.SUPPORTED_IDES = void 0;
exports.SUPPORTED_IDES = [
    {
        value: 'cursor',
        name: 'Cursor',
...
exports.DEFAULT_SELECTED_IDES = ['cursor', 'vscode'];
exports.DEFAULT_SELECTED_AGENTS = ['claude', 'copilot'];
